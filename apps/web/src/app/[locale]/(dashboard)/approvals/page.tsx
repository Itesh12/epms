            ...
            {selectedRequest ? (
              ...
              >
                ...
                <form onSubmit={(e: any) => {
                  ...
                  <textarea name="comment" className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 min-h-[100px] resize-none focus:ring-2 focus:ring-indigo-500 outline-none mb-6 text-gray-900" placeholder={t('commentPlaceholder')} />
