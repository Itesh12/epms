        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 mb-8 border-t-4 border-t-purple-500">
          ...
          <div className="grid grid-cols-2 gap-6 mb-8">
            <div>
              ...
              <input value={newFlow.name} onChange={e => setNewFlow(f => ({...f, name: e.target.value}))} className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl" placeholder={t('ruleNamePlaceholder')} />
            </div>
            <div>
                ...
                <div key={idx} className="flex items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                  ...
                  <div className="flex-1">
                    <select 
                      ...
                      className="w-full outline-none font-semibold text-gray-700 bg-white"
                    >
