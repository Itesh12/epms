    ...
    <div className="mb-6">
      ...
      <div className="relative">
        ...
        <input 
          ...
          className="w-full pl-12 pr-12 py-3.5 rounded-2xl border-2 border-gray-100 focus:border-blue-600 focus:ring-0 transition-all outline-none text-gray-900 font-medium placeholder:text-gray-300"
        />
        {isPassword && (
          <button
            type="button"
