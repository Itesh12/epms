...
- Name: auth.spec.ts >> Authentication E2E >> should register a new admin and land on dashboard
  ...
  - generic [ref=e14]:
    ...
    - generic [ref=e19]:
      ...
      - generic [ref=e27]:
        ...
        - generic [ref=e29]:
          - img [ref=e30]
          - textbox "example@company.com" [ref=e33]: admin_1775908192517@e2e.test
      - generic [ref=e34]:
        - generic [ref=e35]: Organization Name
        - generic [ref=e36]:
          - img [ref=e37]
          - textbox "Enter company name" [ref=e40]: E2E Org 1775908192517
      - generic [ref=e41]:
