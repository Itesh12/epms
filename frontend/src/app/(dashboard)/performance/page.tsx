  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-10 max-w-[1400px]">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
        ...
        <div className="flex items-center gap-4 bg-muted/30 p-1.5 rounded-2xl border border-divider">
      ...
      <div className="bg-card border border-divider rounded-[32px] overflow-hidden shadow-2xl shadow-black/5 relative">
        <div className="px-8 py-6 border-b border-divider flex items-center justify-between bg-muted/5">
          <div className="space-y-1">
            ...
            <p className="text-[10px] font-bold text-muted-foreground/50 uppercase tracking-widest">Employee Saturation & Velocity Index</p>
          </div>
          <TrendingUp size={18} className="text-primary/20" />
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-left">
             <thead className="bg-muted/10 border-b border-divider">
             ...
             <tbody className="divide-y divide-divider font-medium">
                {performance.map((member, index) => (
                  <tr key={member.email} className="group hover:bg-muted/10 transition-colors border-b border-divider last:border-0">
                    <td className="px-8 py-5">
                      <div className="flex items-center gap-4">
                         ...
                         <div>
                           ...
                           <p className="text-[10px] text-muted-foreground/40 font-black uppercase tracking-widest leading-none mt-1">{member.email}</p>
                         </div>
                      </div>
                    </td>
                    ...
                    <td className="px-8 py-5 text-center font-black text-xs text-foreground/70 tabular-nums">
