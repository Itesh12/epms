...
import { X, Loader2, Type, AlignLeft, BarChart, Image as ImageIcon, Palette, Users, Save } from 'lucide-react';
...
export function EditProjectDrawer({ isOpen, onClose, onSuccess, project }: EditProjectDrawerProps) {
  ...
  useEffect(() => {
    if (project && isOpen) {
      ...
      setMemberIds(project.members?.map((m: any) => typeof m === 'string' ? m : m._id) || []);
